...
public class TemperatureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!host.equals("")) {
            makeGardenThingQuery("temperature");
        }
    ...
    private void makeGardenThingQuery(String query) {
        ...
        new TemperatureActivity.GardenThingQueryTask().execute(gardenThingUrl);
    }
        ...
        protected void onPostExecute(String gardenThingResults) {
            ...
            if (gardenThingResults != null && !gardenThingResults.equals("")) {
                ...
                try {
                    ...
                    JSONObject valueObject = jObject.getJSONObject("temperature");
                ...
                XYSeries series1 = new SimpleXYSeries(
                        Arrays.asList(dateArray), Arrays.asList(valueArray), "Temperature");

                // create formatters to use for drawing a series using LineAndPointRenderer
                // and configure them from xml:
                LineAndPointFormatter series1Format =
                        new LineAndPointFormatter(TemperatureActivity.this, R.xml.line_point_formatter_with_labels);
                ...
                // TODO: Move to strings.xml
                plot.setRangeLabel("Temperature (" + unit + ")");
