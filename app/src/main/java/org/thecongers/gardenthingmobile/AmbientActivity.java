...
public class AmbientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!host.equals("")) {
            makeGardenThingQuery("ambientlight");
        }
    ...
    private void makeGardenThingQuery(String query) {
        ...
        new AmbientActivity.GardenThingQueryTask().execute(gardenThingUrl);
    }
    ...
    public class GardenThingQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPostExecute(String gardenThingResults) {
            ...
            if (gardenThingResults != null && !gardenThingResults.equals("")) {
                //Log.d(TAG,"Results: " + groveGardenResults);
                ...
                try {
                    ...
                    JSONObject valueObject = jObject.getJSONObject("ambientlight");
                    ...
                    for (int i=0; i < jArray.length(); i++)
                    {
                        ...
                        try {
                            ...
                            //Log.d(TAG,"Value: " + Integer.parseInt(value));
                ...
                //TODO: Only display graphs if there is atleast 3 data points
                ...
                LineAndPointFormatter series1Format =
                        new LineAndPointFormatter(AmbientActivity.this, R.xml.line_point_formatter_with_labels);
