...
public class IrActivity extends AppCompatActivity {
    ...
    private void makeGardenThingQuery(String query) {
        ...
        new IrActivity.GardenThingQueryTask().execute(groveGardenUrl);
    }
        ...
        protected void onPostExecute(String gardenThingResults) {
            ...
            if (gardenThingResults != null && !gardenThingResults.equals("")) {
                ...
                try {
                    ...
                    JSONObject valueObject = jObject.getJSONObject("ir");
                ...
                XYSeries series1 = new SimpleXYSeries(
                        Arrays.asList(dateArray), Arrays.asList(valueArray), "Infrared");

                // create formatters to use for drawing a series using LineAndPointRenderer
                // and configure them from xml:
                LineAndPointFormatter series1Format =
                        new LineAndPointFormatter(IrActivity.this, R.xml.line_point_formatter_with_labels);
