...
public class LuxActivity extends AppCompatActivity {
    ...
    private void makeGardenThingQuery(String query) {
        ...
        new LuxActivity.GardenThingQueryTask().execute(gardenThingUrl);
    }
        ...
        protected void onPostExecute(String gardenThingResults) {
            ...
            if (gardenThingResults != null && !gardenThingResults.equals("")) {
                ...
                try {
                    ...
                    JSONObject valueObject = jObject.getJSONObject("lux");
                ...
                LineAndPointFormatter series1Format =
                        new LineAndPointFormatter(LuxActivity.this, R.xml.line_point_formatter_with_labels);
